...
class TestValidatorsHabits(TestCase):
    ...
    def test_interval_validator_duck_interval(self):
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            'В интервале нельзя указывать одновременно '
            'день или час или минуты',
            )
    ...
    def test_interval_validator_empty_value(self):
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            'Указанный интервал не может быть пустым, '
    ...
    def test_interval_validator_space_in_value(self):
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            '0/ 10/0 имеет пробелы, это не допустимо',
            )
    ...
    def test_interval_validator_duck_interval_instance(self):
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            '0/10/0/0 должен быть интервалом по типу '
            '"7/0/0" что значит интервал из 7 дней',
            )
    ...
    def test_interval_duck_value_interval(self):
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            'Значение day может быть больше или '
            'равно нулю, либо не более чем 7',
            )
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            'Значение hour не может быть меньше 0 или больше чем 59',
            )
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            'Значение minute не может быть меньше 0 '
            'или больше чем 59',
            )
        ...
        self.assertEqual(
            the_exception.args[0]['interval'],
            'Значение day может быть больше '
            'или равно нулю, либо не более чем 7',
            )
    ...
    def test_two_part_validator_space_in_value(self):
        ...
        the_exception = ex.exception
        self.assertEqual(
            the_exception.args[0]['10:0 0'],
            '10:0 0 имеет пробелы, это не допустимо',
            )
    ...
    def test_two_part_validator_duck_value(self):
        ...
        the_exception = ex.exception
        self.assertEqual(
            the_exception.args[0]['0/10/0'],
            '0/10/0 не является корректным для данного поля, '
            'необходимо использовать разделитель ":" и '
            'стандартный вид должен быть: "18:30"',
            )
        ...
        the_exception = ex.exception
        self.assertEqual(
            the_exception.args[0][':0'],
            'Значения в времени могут быть только циферными',
            )
    ...
    def test_date_day_validator_duck_values(self):
        ...
        the_exception = ex.exception
        self.assertEqual(
            the_exception.args[0]['date'],
            'Значение hour не может быть меньше 0 или больше 23',
            )
        ...
        self.assertEqual(
            the_exception.args[0]['date'],
            'Значение minute не может быть меньше 0 или больше 59',
            )
    ...
    def test_date_minute_validator_duck_values(self):
        ...
        self.assertEqual(
            the_exception.args[0]['date'],
            'Было полученно более двух минут!',
            )
    ...
    def test_nice_habit_pass_test(self):
        ...
        validator = ValidatorNiceHabit(
            'nice_habbit',
            ['nice_habbit', 'reward', 'related_habit'],
            )
    ...
    def test_nice_habit_duck_data(self):
        ...
        the_exception = ex.exception
        self.assertEqual(
            the_exception.args[0]['nice_habbit'],
    ...
    def test_nice_habit_duck_data_2(self):
        ...
        self.assertEqual(
            the_exception.args[0]['nice_habbit'],
            'При указании приятной привычки награду '
            'и связаную привычку указывать нельзя',
            )
    ...
    def test_related_habit_nice_pass_test(self):
        ...
        interval = CrontabSchedule.objects.create(minute=0,
                                                  hour=0,
                                                  day_of_month='*/1',
                                                  )
    ...
    def test_retaled_habit_duck_value(self):
        ...
        cron = CrontabSchedule.objects.create(hour=18,
                                              minute=41,
                                              )
        interval = CrontabSchedule.objects.create(minute=0,
                                                  hour=0,
        ...
        the_exception = ex.exception
        self.assertEqual(
            the_exception.args[0]['related_habit'],
