...
from habits.handlers import (HandleInterval,
                             HandleTimeToDo,
                             HandleTimeToDone,
                             HandleCronScheduleToTask,
                             )
...
class TestHandlersHabits(TestCase):
    ...
    def test_handle_interval(self):
        ...
        self.assertEqual(result_days, CrontabSchedule.objects.get(
            day_of_month='*/30',
            ))
        self.assertEqual(result_hours, CrontabSchedule.objects.get(
            hour='*/23',
            ))
        self.assertEqual(result_minutes, CrontabSchedule.objects.get(
            minute='*/59',
            ))
    ...
    def test_time_to_do(self):
        ...
        self.assertEqual(result, CrontabSchedule.objects.get(
            hour=12,
            minute=20,
            ))
